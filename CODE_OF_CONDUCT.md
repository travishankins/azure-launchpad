...
the **Azure Launchpad (SMB / SMEC Edition)** community a harassment-free
...
discussions, pull requests, commit messages, the docs site, and any other
official channel — and also when an individual is officially representing the
project in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the maintainer through the contact listed in
