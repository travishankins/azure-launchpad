...
Policy assignments are **opt-in** and **fully customer-driven** — see the [Policy catalog](/governance/policy-catalog/) for the recommended list of ALZ-aligned built-in initiatives you can assign at each MG level.
